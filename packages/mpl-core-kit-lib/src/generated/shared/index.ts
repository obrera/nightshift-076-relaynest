...
export type ResolvedAccount<
  ...
  U extends Address<T> | null | ProgramDerivedAddress<T> | TransactionSigner<T> =
    | Address<T>
    | null
...
export function expectAddress<T extends string = string>(
  value: Address<T> | null | ProgramDerivedAddress<T> | TransactionSigner<T> | undefined,
): Address<T> {
  if (!value) {
 ...
 * @internal
 */
export function expectSome<T>(value: null | T | undefined): T {
  if (value == null) {
